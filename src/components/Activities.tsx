    ...
    useEffect(() => {
        transactions.forEach((tx) => {
            if (tx.kind === 'wallet' && tx.type === 'deposit') {
                ...
                //     },
                //     (error: string) => {
                //         logger.log('an error occured while fetching state')
                //     }
                // )
                // setTimeout(() => {
                //     unsubscribe?.();
        ...
        <div className="activities-wrapper">
            ...
            <div className="activities-container">
                ...
                <div className="activities-footer">
                    <button className="tx-link" onClick={() => navigate('/wallet/transactions')}>
                        View All Transactions
                    </button>

                    <button className="primary-btn" onClick={() => navigate('/wallet/invoices')}>
